...
CREATE OR REPLACE FUNCTION public.upsert_crm_record(
  ...
  _household_size text DEFAULT NULL,
  _income text DEFAULT NULL,
  _coverage_type text DEFAULT NULL,
  _consent boolean DEFAULT NULL,
  _qualified boolean DEFAULT NULL,
  _transferred boolean DEFAULT false,
...
BEGIN
  INSERT INTO crm_records (
    ...
    last_campaign_id, last_outcome, source
  ) VALUES (
